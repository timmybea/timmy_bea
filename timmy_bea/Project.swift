...
struct Project {
    ...
    static func getProjectArray() -> [Project] {
        ...
        let meTube = Project(title: "MeTube", shortDescription: "A demonstration app for practising custom UI Design", longDescription: "MeTube is an attempt to recreate the YouTube homepage entirely without the use of storyboards. It has the look and feel of the original interface, loads videos and provides playback options that YouTube users are familiar with.", frameWorks: "NSURLSessions, NSCache, AVFoundation", languages: "Swift", dateCompleted: "February 2017", videoThumbnailName: "MeTube", videoURL: "https://firebasestorage.googleapis.com/v0/b/timmybea-3ba58.appspot.com/o/MeTube.mp4?alt=media&token=a1d6a2ba-c749-4d32-8deb-7ea845cdc1ea", gitHubURL: "https://github.com/timmybea/youtubeHomePage")
